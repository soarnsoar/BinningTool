...
def BinningByCat(cutname1,Year,bincut=0.1):
    ...
    inputf='inputfiles_Boost/'+Year+'.root'
...
if __name__ == '__main__':
    ...
    if cutname=='1':
        cutname='__BoostedGGF_SR_MEKDTAG_M1500_C0.01'
        print '__BoostedGGF_SR_MEKDTAG_M1500_C0.01'
    if cutname=='2':
        cutname='__BoostedGGF_SR_UNTAGGED_M1500_C0.01'
        print '__BoostedGGF_SR_UNTAGGED_M1500_C0.01'
    if cutname=='3':
        cutname='__BoostedVBF_SR_NoMEKDCut'
        print '__BoostedVBF_SR_NoMEKDCut'
